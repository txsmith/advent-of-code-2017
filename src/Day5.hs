...
answer' = do
  ...
  let 
    ...
    getJmpAddr = do
      ...
      instr <- read instructions ptr
      if instr >= 3 
        then modify instructions (subtract 1) ptr
        else modify instructions (+1) ptr
      return instr
